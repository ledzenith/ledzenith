    ...
    const GuaranteeSection = () => {
        ...
        function handleClick(direction){
            ...
            const scrollLeft = newIndex * (carouselRef.current.clientWidth / itemsPerPage);
        ...
        return ( 
            ...
            <div className="wrapper bg-light position-relative">
                ...
                <div className="main-container">
                    ...
                    <div onTouchStart={handlePress} onTouchMove={handleMove} onTouchEnd={handleOut} onMouseUp={handleOut} onMouseDown={handlePress} onMouseMove={handleMove} ref={carouselRef} className={`carousel bg-light ${expand ? "expand" : "gradient-guarantee" }`}>
                                ...
                                <div className="icon-container">
                                    <div className="box">
                                        <i className="bi bi-clock fs-guarantee-icon" draggable="false"></i>
                                        <h5>Tempi di spedizione</h5>
                                    </div>
                                </div>
                                <div className="icon-container">
                                    <div className="box">
                                        <i className="bi bi-truck fs-guarantee-icon" draggable="false"></i>
                                        <h5>Spedizioni gratuite</h5>
                                    </div>
                                </div>
                                <div className="icon-container">
                                    <div className="box">
                                        <i className="bi bi-person-check fs-guarantee-icon" draggable="false"></i>
                                        <h5>Servizio clienti</h5>
                                    </div>
                                </div>
                                <div className="icon-container">
                                    <div className="box">
                                        <i className="bi bi-cash-coin fs-guarantee-icon" draggable="false"></i>
